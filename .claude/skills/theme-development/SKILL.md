...
3. Update theme metadata (`index.js`) and CSS/type exports together with Edit.
...
5. Add or update theme tests when behavior changes, then run them with Bash (`node --test tests/themes.test.js`).
