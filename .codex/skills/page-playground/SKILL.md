...
1. Keep the UI aligned with the real editor behavior.
2. Update data flow, labels, and preview state together.
3. Preserve drag/drop and config-building interactions.
4. Keep bilingual labels in sync with locale behavior.
5. Validate the page against the editor bundle it embeds.
