...
1. Find the owning namespace for the string.
2. Update all required locales together.
3. Keep keys stable unless there is a deliberate rename.
4. Preserve translation parity where the code expects it.
5. Verify the runtime label selection for the affected UI.
